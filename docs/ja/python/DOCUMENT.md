...
nav_order: 5
lang: ja
hreflang_alt: "en/python/DOCUMENT"
hreflang_lang: "en"
mode_counterpart: "/ja/DOCUMENT.html"
---
...
13. [スライスと連結](SLICE_CONCAT)
14. [ワンホットから整数への変換](ONEHOT)
15. [ネイティブ整数変数](NATIVE_INTEGER)
16. [非線形関数とネイティブ制約](CONSTRAINTS)
17. [Easy Solverの使い方](EASYSOLVER)
18. [Exhaustive Solverの使い方](EXHAUSTIVE)
19. [ABS3 Solverの使い方](ABS3)
20. [探索パラメータ](PARAMS)
...
- [QUBO/HUBO ソルバー](QUBO_HUBO_SOLVERS) — QUBO/HUBO モデルを**直接**受け取る（線形化不要）ソルバー: dimod ExactSolver, IBM Qiskit Optimization（厳密・二次直接）、および D-Wave samplers (Neal / Tabu / Steepest Descent), OpenJij, TYTAN-SDK MIKAS, qubovert, Simulated Bifurcation（ヒューリスティックなサンプラ・アニーラ）。
