...
<div class="demo-buttons">
  <button class="demo-btn active" onclick="switchDemo(this,'https://233dwj2zapcrsk6kvnlhwcc3gu0jydbw.lambda-url.ap-northeast-1.on.aws/')">C++ Playground</button>
...
<iframe id="demo-frame" src="https://233dwj2zapcrsk6kvnlhwcc3gu0jydbw.lambda-url.ap-northeast-1.on.aws/"
