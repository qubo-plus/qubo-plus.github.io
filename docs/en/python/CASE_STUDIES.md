...
nav_order: 6
lang: en
hreflang_alt: "ja/python/CASE_STUDIES"
hreflang_lang: "ja"
---
...
2. [Knapsack Problem](KNAPSACK) (Medium)
3. [Shift Scheduling Problem](SHIFT_SCHEDULING) (Hard)
4. [LABS Problem](LABS) (Medium)
5. [Cutting Stock Problem](BAR_CUTTING) (Hard)
6. [Integer Linear Programming](ILP) (Easy)
7. [Interval Subset Sum Problem (ISSP)](ISSP) (Hard)
8. [Three Formulations of the Partitioning Problem](PARTITION_FORMULATIONS) (Easy)
...
5. [Star Battle](STAR_BATTLE) (Medium)
...
## Image processing
1. [Image Halftoning](HALFTONING) (Medium)
