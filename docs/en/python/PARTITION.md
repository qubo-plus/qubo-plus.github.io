...
The case study [Three Formulations of the Partitioning Problem](PARTITION_FORMULATIONS) also formulates this problem with the nonlinear function `abs` and the native constraint `cons()`, and compares the three formulations side by side.
