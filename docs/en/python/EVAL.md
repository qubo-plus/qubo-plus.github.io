...
[Native integer variables](NATIVE_INTEGER) (`qbpp.var(..., integer=(l, u))`) can also be used as keys.
The value must lie within the declared range; an out-of-range value raises `ValueError`.
