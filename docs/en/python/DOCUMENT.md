...
2. [Expressive Power of PyQBPP](MODELING)
3. [Quick Start](QUICK)
...
13. [Slice and Concat](SLICE_CONCAT)
...
- [QUBO/HUBO Solvers](QUBO_HUBO_SOLVERS) — solvers that take the QUBO/HUBO model **directly** (no linearization): dimod ExactSolver, IBM Qiskit Optimization (exact / quadratic-direct), plus the D-Wave samplers (Neal / Tabu / Steepest Descent), OpenJij, TYTAN-SDK MIKAS, qubovert, Simulated Bifurcation (heuristic samplers / annealers).
